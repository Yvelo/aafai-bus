...
class TestSearchGoogleScholarFunctional:
    ...
    def test_search_google_scholar_basic_query(self, mock_setup_driver, mock_get_scholar_profile_details,
    ...
    @patch('src.actions.search_google_scholar._get_scholar_profile_details')
    @patch('src.actions.search_google_scholar._setup_driver')
    def test_search_google_scholar_no_results(self, mock_setup_driver, mock_get_scholar_profile_details,
                                              mock_get_total_estimated_results):
        """
    ...
    @patch('src.actions.search_google_scholar._get_scholar_profile_details')
    @patch('src.actions.search_google_scholar._setup_driver')
    def test_search_google_scholar_pagination(self, mock_setup_driver, mock_get_scholar_profile_details,
                                              mock_get_total_estimated_results):
        """
    ...
    @patch('src.actions.search_google_scholar._get_scholar_profile_details')
    @patch('src.actions.search_google_scholar._setup_driver')
    def test_search_google_scholar_error_handling(self, mock_setup_driver, mock_get_scholar_profile_details,
                                                  mock_get_total_estimated_results):
        """
