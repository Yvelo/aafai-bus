...
class TestDocsendScrapingFunctional:
    ...
    def test_multiple_docsend_downloads(self, temp_dir):
        ...
        docsend_documents = [
            ...
            {"url":"https://docsend.com/view/zbkgdd8xwrmgei6r/d/ya7a6z865j8eukc5","user_email":"yvesloicmartin@aaf.lu","document_name": "07_Publications_BC-seq and metastasis signature","passcode": ""}
        ]
